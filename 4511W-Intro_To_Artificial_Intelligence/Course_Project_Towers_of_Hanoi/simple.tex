...
\begin{figure}
\centering
\includegraphics[width=3.0in]{Hanoi}
...
\begin{figure}
\centering
\includegraphics[width=3.4in]{hanoi_maxFrontier}
...
\begin{figure}
\centering
\includegraphics[width=3.5in]{hanoi_runtime}
...
% \begin{figure*}[!t]
% \centering
% {\includegraphics[width=6.0in]{alg_summary}}
% \caption{Summary of characteristics for the algorithms compared \cite{Textbook01} }
% \label{fig_alg}
% \end{figure*}
